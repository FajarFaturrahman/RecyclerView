...
public class MainActivity extends AppCompatActivity {
    ...
    String[] names = {"I Took A Phill In Ibiza", "7 Years", "Pillow Talk", "Work From Home", "Never Forget You", "Don't Let Me Down", "Love Yourself", "Me, Myself & I", "Cake By The Ocean", "Dangerous Woman", "My House", "Stressed Out", "One Dance", "Middle", "No"};

    String[] singers = {"Mike Posner", "Lukas Graham", "Zayn", "Fifth Harmony", "Zara Larsson & MNEK", "The Chainsmokers", "Justing Bieber", "G-Eazy x Babe Rexha", "DNCE", "Ariana Grande", "Florida", "Twenty One Pilots", "Drake", "DJ Snake", "Meghan Trainer"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //USING AN ARRAYLIST CALLED SONGLIST
